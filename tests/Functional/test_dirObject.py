...
def test_dirStream():
    ...
    cash = (b'\x01\x16\x03\x00\x00\xF0\x00\x00\x00\xD2\x02\x00\x00\xD4\x00\x00'
          ...
          + b'\xFF\x00\x00')
    thisWorkbook.addPerformanceCache(cash)
    ...
    cash = (b'\x01\x16\x03\x00\x00\xF0\x00\x00\x00\x22\x02\x00\x00\xD4\x00\x00'
