def create_standard_cache(cookie):
    return create_cache_header(cookie, b'\x22', 0x8801, 0x29, 0x7D02)


def create_doc_cache(cookie):
    return create_cache_header(cookie, b'\xD2', b'\x00\x02', b'\xD9', b'\x2D\x03', b'\x23\x01')


def create_cache_header(co, c1, c2, c3, c4, c5):
    ca = (b''
