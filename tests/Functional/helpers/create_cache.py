def create_standard_cache(cookie):
    return create_cache_header(cookie, b'\x22', b'\x88\c01', b'\x29',
                               b'\x7D\x02', b'\x03\x00', b'\x02')


def create_doc_cache(cookie):
    return create_cache_header(cookie, b'\xD2', b'\x00\x02', b'\xD9',
                               b'\x2D\x03', b'\x23\x01', b'\x08'
